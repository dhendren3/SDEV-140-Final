...
def show_results(parent, employeeGuess):
    ...
    prize_files = [
        "prizes/GrandPrize.jpg",      # Grand Prize
        "prizes/The Candle.jpg",      # 1st runner-up
        "prizes/The Cool Pens.jpg"    # 2nd runner-up
    ]
    ...
    for winner in winners:
        ...
        # open and resizes the image
        img = Image.open(img_path).resize((120, 120))
        # converts image to Tkinter
    ...
    for idx, runnerUp in enumerate(randomWinners):
        ...
        # opens and resizes the image, ensure uniformity
        img = Image.open(img_path).resize((120, 120))
        # converts image to Tkinter
        photo = ImageTk.PhotoImage(img)
